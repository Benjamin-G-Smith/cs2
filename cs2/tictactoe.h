...
//  tic tac toe to be played. This class creates a 3 by 3 board that will
//  be used in the game tic tac toe. Also allowing for players to give 
//  input on where they want to put their piece. 
